function loadContent () {
    ...
    var displayRuntimeError = function () {
        ...
        setTimeout(function(){ errorContainer.innerHTML = ''; }, 6000);
    }
    ...
    if (host.indexOf(':') > -1 && sourceUrl.indexOf(host) !== sourceUrlParser.protocol.length + 2) {
        host = host.slice(0, host.indexOf(':'));
    }
    var sourceOrigin = sourceUrlParser.protocol + '//' + host;
    var messageHandler = new MessageHandler(window, sourceOrigin, ADAPTER);
